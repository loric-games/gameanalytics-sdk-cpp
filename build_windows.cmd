...
python setup.py --platform win64 --cfg Debug --build --clean --extra-cmake "-DGA_SHARED_LIB=OFF -DGA_BUILD_SAMPLE=OFF -DBUILD_SHARED_LIBS=OFF -DCMAKE_MSVC_RUNTIME_LIBRARY=MultiThreadedDebug" --build-target GameAnalytics
